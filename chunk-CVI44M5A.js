...
`],encapsulation:2})}return i})(),ne=class{index;tab};var bn=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=St({type:i});static \u0275inj=Mt({imports:[Ot]})}return i})();var jt=class{diff(a,t,e={}){let n;typeof e=="function"?(n=e,e={}):"callback"in e&&(n=e.callback);let o=this.castInput(a,e),r=this.castInput(t,e),b=this.removeEmpty(this.tokenize(o,e)),d=this.removeEmpty(this.tokenize(r,e));return this.diffWithOptionsObj(b,d,e,n)}diffWithOptionsObj(a,t,e,n){var o;let r=g=>{if(g=this.postProcess(g,e),n){setTimeout(function(){n(g)},0);return}else return g},b=t.length,d=a.length,f=1,p=b+d;e.maxEditLength!=null&&(p=Math.min(p,e.maxEditLength));let B=(o=e.timeout)!==null&&o!==void 0?o:1/0,O=Date.now()+B,M=[{oldPos:-1,lastComponent:void 0}],E=this.extractCommon(M[0],t,a,0,e);if(M[0].oldPos+1>=d&&E+1>=b)return r(this.buildValues(M[0].lastComponent,t,a));let z=-1/0,Z=1/0,et=()=>{for(let g=Math.max(z,-f);g<=Math.min(Z,f);g+=2){let v,R=M[g-1],L=M[g+1];R&&(M[g-1]=void 0);let ft=!1;if(L){let me=L.oldPos-g;ft=L&&0<=me&&me<b}let xt=R&&R.oldPos+1<d;if(!ft&&!xt){M[g]=void 0;continue}if(!xt||ft&&R.oldPos<L.oldPos?v=this.addToPath(L,!0,!1,0,e):v=this.addToPath(R,!1,!0,1,e),E=this.extractCommon(v,t,a,g,e),v.oldPos+1>=d&&E+1>=b)return r(this.buildValues(v.lastComponent,t,a))||!0;M[g]=v,v.oldPos+1>=d&&(Z=Math.min(Z,g-1)),E+1>=b&&(z=Math.max(z,g+1))}f++};if(n)(function g(){setTimeout(function(){if(f>p||Date.now()>O)return n(void 0);et()||g()},0)})();else for(;f<=p&&Date.now()<=O;){let g=et();if(g)return g}}addToPath(a,t,e,n,o){let r=a.lastComponent;return r&&!o.oneChangePerToken&&r.added===t&&r.removed===e?{oldPos:a.oldPos+n,lastComponent:{count:r.count+1,added:t,removed:e,previousComponent:r.previousComponent}}:{oldPos:a.oldPos+n,lastComponent:{count:1,added:t,removed:e,previousComponent:r}}}extractCommon(a,t,e,n,o){let r=t.length,b=e.length,d=a.oldPos,f=d-n,p=0;for(;f+1<r&&d+1<b&&this.equals(e[d+1],t[f+1],o);)f++,d++,p++,o.oneChangePerToken&&(a.lastComponent={count:1,previousComponent:a.lastComponent,added:!1,removed:!1});return p&&!o.oneChangePerToken&&(a.lastComponent={count:p,previousComponent:a.lastComponent,added:!1,removed:!1}),a.oldPos=d,f}equals(a,t,e){return e.comparator?e.comparator(a,t):a===t||!!e.ignoreCase&&a.toLowerCase()===t.toLowerCase()}removeEmpty(a){let t=[];for(let e=0;e<a.length;e++)a[e]&&t.push(a[e]);return t}castInput(a,t){return a}tokenize(a,t){return Array.from(a)}join(a){return a.join("")}postProcess(a,t){return a}get useLongestToken(){return!1}buildValues(a,t,e){let n=[],o;for(;a;)n.push(a),o=a.previousComponent,delete a.previousComponent,a=o;n.reverse();let r=n.length,b=0,d=0,f=0;for(;b<r;b++){let p=n[b];if(p.removed)p.value=this.join(e.slice(f,f+p.count)),f+=p.count;else{if(!p.added&&this.useLongestToken){let B=t.slice(d,d+p.count);B=B.map(function(O,M){let E=e[f+M];return E.length>O.length?E:O}),p.value=this.join(B)}else p.value=this.join(t.slice(d,d+p.count));d+=p.count,p.added||(f+=p.count)}}return n}};var oe=class extends jt{constructor(){super(...arguments),this.tokenize=Kn}equals(a,t,e){return e.ignoreWhitespace?((!e.newlineIsToken||!a.includes(`
...
`));let t=[],e=i.split(/(\n|\r\n)/);e[e.length-1]||e.pop();for(let n=0;n<e.length;n++){let o=e[n];n%2&&!a.newlineIsToken?t[t.length-1]+=o:t.push(o)}return t}var un={includeIndex:!0,includeUnderline:!0,includeFileHeaders:!0};function se(i,a,t,e,n,o,r){let b;r?typeof r=="function"?b={callback:r}:b=r:b={},typeof b.context>"u"&&(b.context=4);let d=b.context;if(b.newlineIsToken)throw new Error("newlineIsToken may not be used with patch-generation functions, only with diffing functions");if(b.callback){let{callback:p}=b;re(t,e,Object.assign(Object.assign({},b),{callback:B=>{let O=f(B);p(O)}}))}else return f(re(t,e,b));function f(p){if(!p)return;p.push({value:"",lines:[]});function B(g){return g.map(function(v){return" "+v})}let O=[],M=0,E=0,z=[],Z=1,et=1;for(let g=0;g<p.length;g++){let v=p[g],R=v.lines||Yn(v.value);if(v.lines=R,v.added||v.removed){if(!M){let L=p[g-1];M=Z,E=et,L&&(z=d>0?B(L.lines.slice(-d)):[],M-=z.length,E-=z.length)}for(let L of R)z.push((v.added?"+":"-")+L);v.added?et+=R.length:Z+=R.length}else{if(M)if(R.length<=d*2&&g<p.length-2)for(let L of B(R))z.push(L);else{let L=Math.min(R.length,d);for(let xt of B(R.slice(0,L)))z.push(xt);let ft={oldStart:M,oldLines:Z-M+L,newStart:E,newLines:et-E+L,lines:z};O.push(ft),M=0,E=0,z=[]}Z+=R.length,et+=R.length}}for(let g of O)for(let v=0;v<g.lines.length;v++)g.lines[v].endsWith(`
