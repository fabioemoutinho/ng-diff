...
`],encapsulation:2})}return a})(),ht=class{index;tab};var jn=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275mod=je({type:a});static \u0275inj=Fe({imports:[Ge]})}return a})();var se=class{diff(i,e,t={}){let n;typeof t=="function"?(n=t,t={}):"callback"in t&&(n=t.callback);let o=this.castInput(i,t),r=this.castInput(e,t),d=this.removeEmpty(this.tokenize(o,t)),m=this.removeEmpty(this.tokenize(r,t));return this.diffWithOptionsObj(d,m,t,n)}diffWithOptionsObj(i,e,t,n){var o;let r=h=>{if(h=this.postProcess(h,t),n){setTimeout(function(){n(h)},0);return}else return h},d=e.length,m=i.length,p=1,g=d+m;t.maxEditLength!=null&&(g=Math.min(g,t.maxEditLength));let E=(o=t.timeout)!==null&&o!==void 0?o:1/0,M=Date.now()+E,T=[{oldPos:-1,lastComponent:void 0}],R=this.extractCommon(T[0],e,i,0,t);if(T[0].oldPos+1>=m&&R+1>=d)return r(this.buildValues(T[0].lastComponent,e,i));let $=-1/0,K=1/0,ie=()=>{for(let h=Math.max($,-p);h<=Math.min(K,p);h+=2){let k,A=T[h-1],N=T[h+1];A&&(T[h-1]=void 0);let Ce=!1;if(N){let Ft=N.oldPos-h;Ce=N&&0<=Ft&&Ft<d}let Ee=A&&A.oldPos+1<m;if(!Ce&&!Ee){T[h]=void 0;continue}if(!Ee||Ce&&A.oldPos<N.oldPos?k=this.addToPath(N,!0,!1,0,t):k=this.addToPath(A,!1,!0,1,t),R=this.extractCommon(k,e,i,h,t),k.oldPos+1>=m&&R+1>=d)return r(this.buildValues(k.lastComponent,e,i))||!0;T[h]=k,k.oldPos+1>=m&&(K=Math.min(K,h-1)),R+1>=d&&($=Math.max($,h+1))}p++};if(n)(function h(){setTimeout(function(){if(p>g||Date.now()>M)return n(void 0);ie()||h()},0)})();else for(;p<=g&&Date.now()<=M;){let h=ie();if(h)return h}}addToPath(i,e,t,n,o){let r=i.lastComponent;return r&&!o.oneChangePerToken&&r.added===e&&r.removed===t?{oldPos:i.oldPos+n,lastComponent:{count:r.count+1,added:e,removed:t,previousComponent:r.previousComponent}}:{oldPos:i.oldPos+n,lastComponent:{count:1,added:e,removed:t,previousComponent:r}}}extractCommon(i,e,t,n,o){let r=e.length,d=t.length,m=i.oldPos,p=m-n,g=0;for(;p+1<r&&m+1<d&&this.equals(t[m+1],e[p+1],o);)p++,m++,g++,o.oneChangePerToken&&(i.lastComponent={count:1,previousComponent:i.lastComponent,added:!1,removed:!1});return g&&!o.oneChangePerToken&&(i.lastComponent={count:g,previousComponent:i.lastComponent,added:!1,removed:!1}),i.oldPos=m,p}equals(i,e,t){return t.comparator?t.comparator(i,e):i===e||!!t.ignoreCase&&i.toLowerCase()===e.toLowerCase()}removeEmpty(i){let e=[];for(let t=0;t<i.length;t++)i[t]&&e.push(i[t]);return e}castInput(i,e){return i}tokenize(i,e){return Array.from(i)}join(i){return i.join("")}postProcess(i,e){return i}get useLongestToken(){return!1}buildValues(i,e,t){let n=[],o;for(;i;)n.push(i),o=i.previousComponent,delete i.previousComponent,i=o;n.reverse();let r=n.length,d=0,m=0,p=0;for(;d<r;d++){let g=n[d];if(g.removed)g.value=this.join(t.slice(p,p+g.count)),p+=g.count;else{if(!g.added&&this.useLongestToken){let E=e.slice(m,m+g.count);E=E.map(function(M,T){let R=t[p+T];return R.length>M.length?R:M}),g.value=this.join(E)}else g.value=this.join(e.slice(m,m+g.count));m+=g.count,g.added||(p+=g.count)}}return n}};function Ct(a,i){let e;for(e=0;e<a.length&&e<i.length;e++)if(a[e]!=i[e])return a.slice(0,e);return a.slice(0,e)}function kt(a,i){let e;if(!a||!i||a[a.length-1]!=i[i.length-1])return"";for(e=0;e<a.length&&e<i.length;e++)if(a[a.length-(e+1)]!=i[i.length-(e+1)])return a.slice(-e);return a.slice(-e)}function $e(a,i,e){if(a.slice(0,i.length)!=i)throw Error(`string ${JSON.stringify(a)} doesn't start with prefix ${JSON.stringify(i)}; this is a bug`);return e+a.slice(i.length)}function qe(a,i,e){if(!i)return a+e;if(a.slice(-i.length)!=i)throw Error(`string ${JSON.stringify(a)} doesn't end with suffix ${JSON.stringify(i)}; this is a bug`);return a.slice(0,-i.length)+e}function ve(a,i){return $e(a,i,"")}function Se(a,i){return qe(a,i,"")}function Tt(a,i){return i.slice(0,Ti(a,i))}function Ti(a,i){let e=0;a.length>i.length&&(e=a.length-i.length);let t=i.length;a.length<i.length&&(t=a.length);let n=Array(t),o=0;n[0]=0;for(let r=1;r<t;r++){for(i[r]==i[o]?n[r]=n[o]:n[r]=o;o>0&&i[r]!=i[o];)o=n[o];i[r]==i[o]&&o++}o=0;for(let r=e;r<a.length;r++){for(;o>0&&a[r]!=i[o];)o=n[o];a[r]==i[o]&&o++}return o}function Mt(a,i){let e=[];for(let t of Array.from(i.segment(a))){let n=t.segment;e.length&&/\s/.test(e[e.length-1])&&/\s/.test(n)?e[e.length-1]+=n:e.push(n)}return e}function Ue(a,i){if(i)return ye(a,i)[1];let e;for(e=a.length-1;e>=0&&a[e].match(/\s/);e--);return a.substring(e+1)}function de(a,i){if(i)return ye(a,i)[0];let e=a.match(/^\s*/);return e?e[0]:""}function ye(a,i){if(!i)return[de(a),Ue(a)];if(i.resolvedOptions().granularity!="word")throw new Error('The segmenter passed must have a granularity of "word"');let e=Mt(a,i),t=e[0],n=e[e.length-1],o=/\s/.test(t)?t:"",r=/\s/.test(n)?n:"";return[o,r]}var Ze="a-zA-Z0-9_\\u{AD}\\u{C0}-\\u{D6}\\u{D8}-\\u{F6}\\u{F8}-\\u{2C6}\\u{2C8}-\\u{2D7}\\u{2DE}-\\u{2FF}\\u{1E00}-\\u{1EFF}",Mi=new RegExp(`[${Ze}]+|\\s+|[^${Ze}]`,"ug"),wt=class extends se{equals(i,e,t){return t.ignoreCase&&(i=i.toLowerCase(),e=e.toLowerCase()),i.trim()===e.trim()}tokenize(i,e={}){let t;if(e.intlSegmenter){let r=e.intlSegmenter;if(r.resolvedOptions().granularity!="word")throw new Error('The segmenter passed must have a granularity of "word"');t=Mt(i,r)}else t=i.match(Mi)||[];let n=[],o=null;return t.forEach(r=>{/\s/.test(r)?o==null?n.push(r):n.push(n.pop()+r):o!=null&&/\s/.test(o)?n[n.length-1]==o?n.push(n.pop()+r):n.push(o+r):n.push(r),o=r}),n}join(i){return i.map((e,t)=>t==0?e:e.replace(/^\s+/,"")).join("")}postProcess(i,e){if(!i||e.oneChangePerToken)return i;let t=null,n=null,o=null;return i.forEach(r=>{r.added?n=r:r.removed?o=r:((n||o)&&Vn(t,o,n,r,e.intlSegmenter),t=r,n=null,o=null)}),(n||o)&&Vn(t,o,n,null,e.intlSegmenter),i}},wi=new wt;function Vn(a,i,e,t,n){if(i&&e){let[o,r]=ye(i.value,n),[d,m]=ye(e.value,n);if(a){let p=Ct(o,d);a.value=qe(a.value,d,p),i.value=ve(i.value,p),e.value=ve(e.value,p)}if(t){let p=kt(r,m);t.value=$e(t.value,m,p),i.value=Se(i.value,p),e.value=Se(e.value,p)}}else if(e){if(a){let o=de(e.value,n);e.value=e.value.substring(o.length)}if(t){let o=de(t.value,n);t.value=t.value.substring(o.length)}}else if(a&&t){let o=de(t.value,n),[r,d]=ye(i.value,n),m=Ct(o,r);i.value=ve(i.value,m);let p=kt(ve(o,m),d);i.value=Se(i.value,p),t.value=$e(t.value,o,p),a.value=qe(a.value,o,o.slice(0,o.length-p.length))}else if(t){let o=de(t.value,n),r=Ue(i.value,n),d=Tt(r,o);i.value=Se(i.value,d)}else if(a){let o=Ue(a.value,n),r=de(i.value,n),d=Tt(o,r);i.value=ve(i.value,d)}}var It=class extends se{tokenize(i){let e=new RegExp(`(\\r?\\n)|[${Ze}]+|[^\\S\\n\\r]+|[^${Ze}]`,"ug");return i.match(e)||[]}},Hn=new It;function Pt(a,i,e){return Hn.diff(a,i,e)}var Dt=class extends se{constructor(){super(...arguments),this.tokenize=Pi}equals(i,e,t){return t.ignoreWhitespace?((!t.newlineIsToken||!i.includes(`
...
`));let e=[],t=a.split(/(\n|\r\n)/);t[t.length-1]||t.pop();for(let n=0;n<t.length;n++){let o=t[n];n%2&&!i.newlineIsToken?e[e.length-1]+=o:e.push(o)}return e}var zn={includeIndex:!0,includeUnderline:!0,includeFileHeaders:!0};function Et(a,i,e,t,n,o,r){let d;r?typeof r=="function"?d={callback:r}:d=r:d={},typeof d.context>"u"&&(d.context=4);let m=d.context;if(d.newlineIsToken)throw new Error("newlineIsToken may not be used with patch-generation functions, only with diffing functions");if(d.callback){let{callback:g}=d;St(e,t,Object.assign(Object.assign({},d),{callback:E=>{let M=p(E);g(M)}}))}else return p(St(e,t,d));function p(g){if(!g)return;g.push({value:"",lines:[]});function E(h){return h.map(function(k){return" "+k})}let M=[],T=0,R=0,$=[],K=1,ie=1;for(let h=0;h<g.length;h++){let k=g[h],A=k.lines||Di(k.value);if(k.lines=A,k.added||k.removed){if(!T){let N=g[h-1];T=K,R=ie,N&&($=m>0?E(N.lines.slice(-m)):[],T-=$.length,R-=$.length)}for(let N of A)$.push((k.added?"+":"-")+N);k.added?ie+=A.length:K+=A.length}else{if(T)if(A.length<=m*2&&h<g.length-2)for(let N of E(A))$.push(N);else{let N=Math.min(A.length,m);for(let Ee of E(A.slice(0,N)))$.push(Ee);let Ce={oldStart:T,oldLines:K-T+N,newStart:R,newLines:ie-R+N,lines:$};M.push(Ce),T=0,R=0,$=[]}K+=A.length,ie+=A.length}}for(let h of M)for(let k=0;k<h.lines.length;k++)h.lines[k].endsWith(`
