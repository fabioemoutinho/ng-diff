...
`],encapsulation:2})}return i})(),ne=class{index;tab};var bn=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=St({type:i});static \u0275inj=Mt({imports:[Ot]})}return i})();var Vt=class{diff(a,t,e={}){let n;typeof e=="function"?(n=e,e={}):"callback"in e&&(n=e.callback);let o=this.castInput(a,e),r=this.castInput(t,e),c=this.removeEmpty(this.tokenize(o,e)),l=this.removeEmpty(this.tokenize(r,e));return this.diffWithOptionsObj(c,l,e,n)}diffWithOptionsObj(a,t,e,n){var o;let r=g=>{if(g=this.postProcess(g,e),n){setTimeout(function(){n(g)},0);return}else return g},c=t.length,l=a.length,f=1,p=c+l;e.maxEditLength!=null&&(p=Math.min(p,e.maxEditLength));let B=(o=e.timeout)!==null&&o!==void 0?o:1/0,O=Date.now()+B,T=[{oldPos:-1,lastComponent:void 0}],E=this.extractCommon(T[0],t,a,0,e);if(T[0].oldPos+1>=l&&E+1>=c)return r(this.buildValues(T[0].lastComponent,t,a));let z=-1/0,Z=1/0,et=()=>{for(let g=Math.max(z,-f);g<=Math.min(Z,f);g+=2){let v,R=T[g-1],L=T[g+1];R&&(T[g-1]=void 0);let ft=!1;if(L){let me=L.oldPos-g;ft=L&&0<=me&&me<c}let xt=R&&R.oldPos+1<l;if(!ft&&!xt){T[g]=void 0;continue}if(!xt||ft&&R.oldPos<L.oldPos?v=this.addToPath(L,!0,!1,0,e):v=this.addToPath(R,!1,!0,1,e),E=this.extractCommon(v,t,a,g,e),v.oldPos+1>=l&&E+1>=c)return r(this.buildValues(v.lastComponent,t,a))||!0;T[g]=v,v.oldPos+1>=l&&(Z=Math.min(Z,g-1)),E+1>=c&&(z=Math.max(z,g+1))}f++};if(n)(function g(){setTimeout(function(){if(f>p||Date.now()>O)return n(void 0);et()||g()},0)})();else for(;f<=p&&Date.now()<=O;){let g=et();if(g)return g}}addToPath(a,t,e,n,o){let r=a.lastComponent;return r&&!o.oneChangePerToken&&r.added===t&&r.removed===e?{oldPos:a.oldPos+n,lastComponent:{count:r.count+1,added:t,removed:e,previousComponent:r.previousComponent}}:{oldPos:a.oldPos+n,lastComponent:{count:1,added:t,removed:e,previousComponent:r}}}extractCommon(a,t,e,n,o){let r=t.length,c=e.length,l=a.oldPos,f=l-n,p=0;for(;f+1<r&&l+1<c&&this.equals(e[l+1],t[f+1],o);)f++,l++,p++,o.oneChangePerToken&&(a.lastComponent={count:1,previousComponent:a.lastComponent,added:!1,removed:!1});return p&&!o.oneChangePerToken&&(a.lastComponent={count:p,previousComponent:a.lastComponent,added:!1,removed:!1}),a.oldPos=l,f}equals(a,t,e){return e.comparator?e.comparator(a,t):a===t||!!e.ignoreCase&&a.toLowerCase()===t.toLowerCase()}removeEmpty(a){let t=[];for(let e=0;e<a.length;e++)a[e]&&t.push(a[e]);return t}castInput(a,t){return a}tokenize(a,t){return Array.from(a)}join(a){return a.join("")}postProcess(a,t){return a}get useLongestToken(){return!1}buildValues(a,t,e){let n=[],o;for(;a;)n.push(a),o=a.previousComponent,delete a.previousComponent,a=o;n.reverse();let r=n.length,c=0,l=0,f=0;for(;c<r;c++){let p=n[c];if(p.removed)p.value=this.join(e.slice(f,f+p.count)),f+=p.count;else{if(!p.added&&this.useLongestToken){let B=t.slice(l,l+p.count);B=B.map(function(O,T){let E=e[f+T];return E.length>O.length?E:O}),p.value=this.join(B)}else p.value=this.join(t.slice(l,l+p.count));l+=p.count,p.added||(f+=p.count)}}return n}};var oe=class extends Vt{constructor(){super(...arguments),this.tokenize=Kn}equals(a,t,e){return e.ignoreWhitespace?((!e.newlineIsToken||!a.includes(`
